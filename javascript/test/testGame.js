...
var findPlayersCoinDetails = function (coins) {
    ...
    Object.keys(coins).forEach(function (coin) {
        coinsDetails[coin] = {
            'id': coins[coin].id, 'currentPosition': coins[coin].currentPosition,
...
describe('Game', function () {
    ...
    describe('createPlayer', function () {
        ...
        it('creates a player with respective coins', function () {
            game.createPlayer('rock');
            var coins = {
                rock1: {id: 'rock1', currentPosition: -1, reachedDestination: false, colour: 'red'},
        ...
        it('creates multiple players with their respective coins', function () {
            ...
            game.createPlayer('gwen');
            coins = {
                gwen1: {id: 'gwen1', currentPosition: -1, reachedDestination: false, colour: 'green'},
            ...
            game.createPlayer('peter');
            coins = {
                peter1: {id: 'peter1', currentPosition: -1, reachedDestination: false, colour: 'blue'},
            ...
            game.createPlayer('jiya');
            coins = {
                jiya1: {id: 'jiya1', currentPosition: -1, reachedDestination: false, colour: 'yellow'},
